...
GitRunner::ReturnCodes ChangeSet::fillFromDiffFile(QIODevice &file)
{
...
GitRunner::ReturnCodes ChangeSet::fillFromCurrentChanges(const QStringList &paths, bool doGenerateHunks )
{
