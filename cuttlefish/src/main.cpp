...
{
    if (msg.contains("qt.svg") && msg.contains("Could not resolve property: #linearGradient")) {
        // We don't want Qt's SVG renderer telling us how garbage it is to get in the way of 
